...
(crontab -l 2>/dev/null; echo "0 17 1 * * /home/ubuntu/pipeline/weekly_retrain.sh >> /home/ubuntu/logs/cron.log 2>&1") | crontab -
...
echo "  - Monthly retrain: 1 AM SGT on 1st of month (5 PM UTC)"
echo ""